...
Promise.all([MongoClient.connect(process.env.SERVER_1, optionsDB), MongoClient.connect(process.env.SERVER_2, optionsDB), MongoClient.connect(process.env.SERVER_3, optionsDB), MongoClient.connect(process.env.SERVER_4, optionsDB), MongoClient.connect(process.env.SERVER_5, optionsDB)])
    .then((db) => {
